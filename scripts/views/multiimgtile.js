...
(function(){
    ...
    CT.MultiImgTile = function(){

    }

    CT.MultiImgTile.prototype = {
        /**
         * 插件id
         */
        id: "MultiImgTileView",
        ...
        _createLayout: function(){
            ...
            this.ele.children("div").append('<div style="padding: 10px; width: 50%;" class="client">' +
                ...
                '</div>'+
                '<div class="form_row">' +
                    '<lable>影像文件:</lable><input id="st_host"><input type="file" multiple title="选择影像文件" id="st_hosthelper" accept=".img,.tif">' +
                '</div>'+
                '<div class="form_row">' +
            ...
            $("#load_layer_config", this.ele).append('<input type="file" id="load_layer_config_helper" nwworkingdir="'+layerspath+'" accept=".mlt">');
        ...
        storeLayerInfo: function(params){
            ...
            var filepath = path.dirname(process.execPath)+CT.LAYERSPATH+"/"+name+".mlt";
        ...
        start: function(){
            ...
            var params = {
                ...
                startzoom: $("#st_startzoom", this.ele).val(),
                endzoom: $("#st_endzoom", this.ele).val(),
        ...
        deleteLayerStore: function(layer){
            var filepath = path.dirname(process.execPath)+CT.LAYERSPATH+"/"+layer.name+".mlt";
            fs.unlink(filepath);
        },
