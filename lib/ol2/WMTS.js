...
OpenLayers.Layer.WMTS = OpenLayers.Class(OpenLayers.Layer.Grid, {
    ...
    getTileInfo: function(loc) {
        ...
        var fy;
        var maxy = Math.floor(this.tileFullExtent.getHeight() / res / this.tileSize.h);
        if(this.isOriginLeftTop){
        	fy = (this.tileOrigin.lat - loc.lat) / (res * this.tileSize.h);
        }else{
        	fy = (loc.lat - this.tileOrigin.lat) / (res * this.tileSize.h);
        }
    ...
    getURL: function(bounds) {
        ...
        var zoom = this.getIdentifier();
        var url = "";
        if((!this.tileFullExtent || this.tileFullExtent.intersectsBounds(bounds)) && this.matrix) {
